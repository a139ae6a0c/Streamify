...
namespace Streamify.NewFolder1
{
    class Artist_player
    {
        ...
        {
            Console.Title = "Streamify - Streaming Artist";
        ...
        */
        ...
        public static bool login(string email, string password)
        {
            ...
            try
            {
                ...
                starter++;
                wait2.Until(ExpectedConditions.ElementIsVisible(By.XPath("//*[@id=\"main\"]/div/div[2]/div[3]/main/div[2]/div[2]/div/div/div[2]/section/div/div[2]/div[2]/div/button[1]"))).Click();
                count++;
                Console.WriteLine("[Playing Artist] Email: " + email + " Password: " + password, Color.FromArgb(30, 215, 96));
                return true;
            }
            catch
            {
                Console.WriteLine("[Error playing] Email: " + email + " Password: " + password, ColorTranslator.FromHtml("#cc0000"));
                driver.Close();
                return false;
            }
        }
